...
function S4() {
	...
	//The toString() method converts a number to a string. i used 16 because that will show as an hexadecimal value	//The substr() method extracts parts of a string substr(start, length), i used only the start (1)
